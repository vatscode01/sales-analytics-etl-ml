...
End-to-End Sales Analytics Platform | Python | PostgreSQL | ETL | SQL | Power BI | Machine Learning

# Things I learned today
The amazon database is big, messy and includes a lot of columns with mostly null values. 
